...
},
{
  ...
  "body": " Preface to the Second Edition  You are viewing the second edition of our open source book originally titled, How We Got from There to Here: A Story of Real Analysis. As much as we liked our original title we discovered, much to our dismay, that it led many people to believe that it is about the history of mathematics rather than a textbook. We were so caught up in using history to tell the story behind the nonintuitive, rigorous definitions and theorems found in a typical undergraduate introductory analysis class that we mistakenly assumed that others would understand our intent before actually opening the book. We were wrong so we have changed the title for this second edition. We hope the new title make our intentions clear.  When we wrote the first edition we deliberately chose to forego any mention of integration theory in order to keep the size of the text manageable. We assumed that students were familiar with the methods by which integrals can be computed, especially Integration by Parts, from calculus class and we relied on this knowledge. But in keeping with our intention to follow the historical development of our topic we did not examine any underlying theory of integration, not even Cauchy since the integral was understood as antidifferentiation long before Cauchy and Riemann were born.  Upon teaching from the first edition for many years, we came to the concluded that we should really provide at least an introduction to the theory of integration for those students who go on to a course in Measure Theory , for instance.  To that end we have re arranged the topics as follows:   We created a new chapter 10 ( Limits, Derivatives, Integrals, and the Fundamental Theorem of Calculus ) and placed in it the sections on the definitions of limit and derivative which had previously been in .    We also added two new sections to . In we prove the Fundamental Theorem Of Calculus and in we define the Cauchy, Riemann, and Darboux integrals. If this seems backwards to you, consider that this is how mathematics is usually created. Foundational issues are typically the last piece of the puzzle.    Additionally we have expanded (formely Chapter 11) to include and where we define the Lebesgue integral in its historical context.  In we expand more on Cantor s influence and the transferal of analysis to a modern set theoretical setting which provides the interested student with a path to studying point set topology in a future course. We believe this is appropriate for an introductory book.  Of course, the rise in set theory leads to Lebesgue measure and the Lebesgue integral . We scratch the surface of those topics in in order to provide the interested student with a starting point to begin studying those topics as well.     On a more nuts and bolts level, most of the problems in the last edition were embedded in the text, with a few sections labeled Additional Problems. This new edition has absorbed those additional problems into the body of the text. This represents the authors evolution. After learning and teaching from conventional math books for most of our careers we have decided that the problems are part of the story of how we got from there to here and should be treated as such. In particular they should be placed in their proper context.  "
},
{
  "id": "ASORA-2-5-4",
  "level": "2",
  "url": "ASORA-2-5.html#ASORA-2-5-4",
...
{
  "id": "SECTIONRiseSetTheory-23",
  "level": "2",
  "url": "SECTIONRiseSetTheory.html#SECTIONRiseSetTheory-23",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-7",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Properties of a Measure    Lebesgue determined that a measure  of a set of real numbers should have the following properties   If is an interval of length then . (We include intervals with the same left and right endpoint: ).    If is a sequence of sets in then with equality when are pairwise disjoint i.e, .     is translation invariant. More precisely, if is a subset of , is any real number, and then ( is said to be shift invariant , meaning that if you shift every element of by some amount the measure of the set is unchanged.)      "
},
{
  "id": "SECTIONLebesgueIntegration-3-10",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "measure "
...
{
  "id": "SECTIONLebesgueIntegration-3-13",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-13",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-15",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-15",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "open cover "
...
{
  "id": "SECTIONLebesgueIntegration-3-19",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-19",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-21",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-21",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Lebesgue Measure "
...
{
  "id": "SECTIONLebesgueIntegration-3-23",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-23",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-26",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-26",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-29",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-29",
  "type": "Problem",
  "number": "12.3.20",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-34",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-34",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-37",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-37",
  "type": "Problem",
  "number": "12.3.24",
  "title": "",
...
{
  "id": "SECTIONLebesgueIntegration-3-41",
  "level": "2",
  "url": "SECTIONLebesgueIntegration.html#SECTIONLebesgueIntegration-3-41",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "12.3.31",
  "title": "",
  "body": "  Look again at your response to .     Was your intuition correct?      Use and to determine the correct answer to and prove that it is correct.     Notice that we have avoided the question of the integrability of a function with uncountably many discontinuities. That is because it is the measure of the set, not its cardinality, which determines its integrability properties. And there are both uncountable sets with zero and non zero measure. Perhaps the most famous of the former is the Cantor s middle third set .   "
},
{
...
{
  "id": "BackToFourier-CantorsTheorem-23",
  "level": "2",
  "url": "BackToFourier-CantorsTheorem.html#BackToFourier-CantorsTheorem-23",
  "type": "Problem",
  "number": "12.4.8",
  "title": "",
...
{
  "id": "BackToFourier-CantorsTheorem-38-1-1",
  "level": "2",
  "url": "BackToFourier-CantorsTheorem.html#BackToFourier-CantorsTheorem-38-1-1",
  "type": "Figure",
  "number": "12.4.14",
  "title": "",
...
{
  "id": "BackToFourier-CantorsTheorem-39",
  "level": "2",
  "url": "BackToFourier-CantorsTheorem.html#BackToFourier-CantorsTheorem-39",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "undecidable "
